...
struct DeployState: Equatable {
    var newIndexes: [ResourceIndexes] = []
    var deleteIndexes: [ResourceIndexes] = []
    var updateIndexes: [ResourceIndexes] = []
...
enum DeployAction {
    ...
    case setNewIndexes([ResourceIndexes])
    case setDeleteIndexes([ResourceIndexes])
    case setUpdateIndexes([ResourceIndexes])
        ...
        return Effect.run { subscriber in
            Task {
                ...
                do {
                    ...
                    var cloudIndexes = try await env.cktool.queryResourceIndexRecords()
